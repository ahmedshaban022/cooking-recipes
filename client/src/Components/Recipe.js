      ...
      <div    className='row '>
      {
        ...
        <div className="card-body">
          ...
          <div className="card-text">
            <button className='btn btn-danger me-2' onClick={()=>removeRecipe(recipe)}>Remove </button>
            <NavLink className='btn btn-info ms-2' to={`/recipe-details/${recipe._id}`}>Details</NavLink>
          </div>
        </div>
      </div>
  </div>
